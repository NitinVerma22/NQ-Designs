...
import PdfAutoScrollCard from '../components/PdfAutoScrollCard';
...
const PortfolioPage = () => {
  ...
  return (
    <div>
      <main className="space-y-8 md:space-y-24 px-4 sm:px-8 md:px-16 py-18 w-full max-w-screen-xl mx-auto bg-[#d8ccc2] md:bg-none">
        {/* About Section */}
        <AnimatedOnScroll>
